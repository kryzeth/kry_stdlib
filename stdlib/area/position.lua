...
-- @usage local Position = require('__stdlib2-continued__/stdlib/area/position')
-- @see Area.Area
-- @see Concepts.Position
-- @see defines.direction
local Position = { __class = 'Position', __index = require('__stdlib2-continued__/stdlib/core') }
